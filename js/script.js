window.onload = function () {
  ...
  function videoReset() {
    ...
    //일단 타이머를 청소한다.
    //clearTimeout: 1번 실행 clearTimeout()
    //clearInterval : 시간마다 연속 실행 calearInterval()
    clearInterval(videoTimer);
    //비디오 플레이시간
    // console.log("시간배열 videosTimeArr", videosTimeArr);
    // console.log("현재시간 videoIndex", videoIndex);
    let videoTime = videosTimeArr[videoIndex];
    // console.log("선택된시간 videoTime", videoTime);
